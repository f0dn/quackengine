...
def test_evaluation():
    ...
    print(engine.evaluate_position())
    engine = Engine("1Q6/5ppk/p6p/1p6/5n2/2N5/PP3PbP/6K1 b - - 1 28")
    print(engine.evaluate_position())
    engine = Engine("8/5ppk/p6p/1p3Q2/5n2/2N5/PP3PbP/6K1 b - - 1 28")
    print(engine.evaluate_position())
...
def test_evaluate_pawn_formation():
    ...
    assert engine.evaluate_pawn_formation() == -600
